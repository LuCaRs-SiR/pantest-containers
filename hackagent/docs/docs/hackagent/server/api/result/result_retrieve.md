---
sidebar_label: result_retrieve
title: hackagent.server.api.result.result_retrieve
---
...
def sync_detailed(id: UUID, *,
                  client: AuthenticatedClient) -> Response[Result]
```
...
```python
def sync(id: UUID, *, client: AuthenticatedClient) -> Result | None
```
...
```python
async def asyncio(id: UUID, *, client: AuthenticatedClient) -> Result | None
```
