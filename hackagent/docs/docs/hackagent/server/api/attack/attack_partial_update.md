---
sidebar_label: attack_partial_update
title: hackagent.server.api.attack.attack_partial_update
---
...
def sync_detailed(
        ...
        *,
        ...
        body: PatchedAttackRequest | Unset = UNSET) -> Response[Attack]
```
...
**Arguments**:
  ...
  id (UUID):
- `body` _PatchedAttackRequest | Unset_ - Serializer for the Attack model, which represents an
...
def sync(id: UUID,
         *,
         client: AuthenticatedClient,
         body: PatchedAttackRequest | Unset = UNSET) -> Attack | None
```
